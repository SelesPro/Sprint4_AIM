...
<?php
  ...
  <section class="container-fluid row">
    ...
    <div class="card-body">
      <?php
      $mod3 = $_GET['modFor'];
      $sqlcon3= "SELECT usuario.nombre,usuario.apellido1,usuario.apellido2, promocion.id_promocion, promocion.fk_promoyear, usuario.id_usuario, usuario.cargo
      ...
      WHERE usuario.cargo='f' and usuario.id_usuario='$mod3'";
      include 'conex.php';
